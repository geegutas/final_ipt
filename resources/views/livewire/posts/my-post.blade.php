<div class="div">
    ...
    <div class="container ">
        ...
        <div class="post-body">
            <div class="col-md-8" style="width: 560px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:white;background-color: #f1a55e;" data-toggle="modal" data-target="#click">+ Create new talk</button>
                </div>
            </div>
        ...
        @if($posts->isEmpty())
            <div style="color: red">
                <h1 class="text-center mt-4" style="font-size: 30px;">No posts.</h1>
            </div>
        @endif
