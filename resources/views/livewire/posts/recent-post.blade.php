<div class="container col-md-12">
    ...
    <div class="profile">
        <h2 class="mt-3 text-white" style="font-weight: 400; font-size: 30px;">Recent Talks</h2>
    </div>
    <div class="post-body">
        ...
        <div class="col-md-4">
            ...
            @endif
            <select class="form-select mb-1 float-right" wire:model.lazy="title">
...
<style>
    ...
    #lc:hover {
        background-color: rgba(71, 242, 165, 0.593);
    }
    .male {
    ...
    .transgender {
        background-image: linear-gradient(to left, rgb(14, 105, 165), rgb(228, 102, 205),rgb(245, 229, 246), rgb(228, 102, 165) rgb(22, 120, 185));
        padding: 3px;
        color: rgb(23, 17, 84);
        border-radius: 3px;
    }
