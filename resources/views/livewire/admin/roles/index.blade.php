<div>
    <div class="container mt-3">
        ...
        @endif
        <div class='btn btn-primary btn-sm float-end mb-2'  style="background-color: #86c8b9; color:white;" data-toggle="modal" data-target="#modal-roles"> + Create New Role</div>
        ...
        <div class="card-body">
            <table class="table shadow-lg text-center">
                <thead style="background-color:#78c1f4; color:#f4f9ed;">
                    <tr>
                        <th>Role</th>
                        <th>Action</th>
                    </tr>
