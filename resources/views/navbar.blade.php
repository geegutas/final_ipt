<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color:#c5c4c1;">

    <h2 class="p-2 text-white" style="font-size:23px; font-weight:400;"><span class="fas fa-comments"></span>Friendster</h2>
        ...
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ 'recent-post' == request()->path() ? 'active' : '' }}"
                    href="{{ '/recent-post' }}"><span class="fas fa-commenting-o"></span>Recent Post</a>
            </li>
...
<style>
    #profile-name a {
        ...
        color: rgb(229, 169, 169);
    }

    #profile-name a:hover {
        background-color: rgba(240, 225, 235, 0);
